            ...
            <div className="min-h-screen bg-mainbg bg-cover bg-no-repeat flex justify-center items-center">
                <div className="max-w-[526px] w-full px-3 sm:px-0">
                    ...
                    <div className=' bg-lightgray rounded-[26px] w-full max-w-[526px] p-5 sm:p-6 md:p-[30px]'>
                        ...
                        <p className='text-white text-opacity-60 text-base '>Loss password? Don’t worry we got you.</p>
                        <Button className="!text-white mt-6 sm:mt-7 md:mt-8 lg:mt-10 py-3 md:py-4 lg:py-[18px] bg_pinkGradient hover:!border-lightBlack duration-500" >Send OTP</Button>
                    </div>
